        ...
        signUpBtn.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if (login.isBlank() || password.isBlank() || confirmPassword.isBlank()) {
                    ...
                    Toast.makeText(RegActivity.this, "login or password need more than 7 symbol", Toast.LENGTH_SHORT).show();
                } else if (!Pattern.matches(digitPattern, password)) {
                    Toast.makeText(RegActivity.this, "passwords hasnt digit", Toast.LENGTH_SHORT).show();
                } else if (!Pattern.matches(specialCharPattern, password)) {
                    Toast.makeText(RegActivity.this, "passwords hasnt special symbol", Toast.LENGTH_SHORT).show();
                } else {
                    mainLogin = login;
